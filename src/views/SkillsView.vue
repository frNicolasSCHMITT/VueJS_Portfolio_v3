<template>
  ...
  <section class="skill-section">
    <div class="skill-group">
      ...
      <div class="skill-pair">
        <div class="skill-image">
          <svg xmlns="http://www.w3.org/2000/svg" aria-label="HTML5" role="img" viewBox="0 0 512 512">
            <title>HTML 5</title>
            <path class="svg-color" fill="#e34f26" d="M71 460L30 0h451l-41 460-185 52"/>
            <path class="svg-color" fill="#ef652a" d="M256 472l149-41 35-394H256"/>
        ...
        <div class="skill-text">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus numquam temporibus soluta voluptate beatae excepturi quibusdam animi accusamus veritatis nemo itaque harum debitis vitae ea, dolore quae ipsa repudiandae earum.
        </div>
      </div>
      <div class="skill-pair">
        <div class="skill-image">
          <svg xmlns="http://www.w3.org/2000/svg" aria-label="CSS3" role="img" viewBox="0 0 512 512">
            <title>CSS 3</title>
            <path class="svg-color" fill="#264de4" d="M72 460L30 0h451l-41 460-184 52"/>
            <path class="svg-color" fill="#2965f1" d="M256 37V472l149-41 35-394"/>
        ...
        <div class="skill-text">
          Lorem ipsum dolor, sit amet consectetur adipisicing elit. Odio perferendis quam ipsa porro, soluta deserunt adipisci quidem rerum harum, dolores temporibus ad, earum tempore mollitia accusamus commodi corrupti reprehenderit? Incidunt!
        </div>
      </div>
      <div class="skill-pair">
        <div class="skill-image">
          <svg viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet">
            ...
            <path class="svg-color" d="M0 0h256v256H0V0z" fill="#F7DF1E"/>
            <path class="color-white" d="M67.312 213.932l19.59-11.856c3.78 6.701 7.218 12.371 15.465 12.371 7.905 0 12.89-3.092 12.89-15.12v-81.798h24.057v82.138c0 24.917-14.606 36.259-35.916 36.259-19.245 0-30.416-9.967-36.087-21.996M152.381 211.354l19.588-11.341c5.157 8.421 11.859 14.607 23.715 14.607 9.969 0 16.325-4.984 16.325-11.858 0-8.248-6.53-11.17-17.528-15.98l-6.013-2.58c-17.357-7.387-28.87-16.667-28.87-36.257 0-18.044 13.747-31.792 35.228-31.792 15.294 0 26.292 5.328 34.196 19.247L210.29 147.43c-4.125-7.389-8.591-10.31-15.465-10.31-7.046 0-11.514 4.468-11.514 10.31 0 7.217 4.468 10.14 14.778 14.608l6.014 2.577c20.45 8.765 31.963 17.7 31.963 37.804 0 21.654-17.012 33.51-39.867 33.51-22.339 0-36.774-10.654-43.819-24.574"/>
          </svg>
        </div>
        <div class="skill-text">
          Lorem ipsum dolor, sit amet consectetur adipisicing elit. Odio perferendis quam ipsa porro, soluta deserunt adipisci quidem rerum harum, dolores temporibus ad, earum tempore mollitia accusamus commodi corrupti reprehenderit? Incidunt!
    ...
    <div class="skill-group">
      <h2 class="text-right">Frameworks & Librairies</h2>
      <div class="skill-pair reverse">
        <div class="skill-image">
          <svg viewBox="0 0 256 256" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
            <title>Bootstrap</title>
            <g>
              <path class="svg-color" d="M0,222.991225 C0,241.223474 14.7785318,256 33.0087747,256 L222.991225,256 C241.223474,256 256,241.221468 256,222.991225 L256,33.0087747 C256,14.7765263 241.221468,0 222.991225,0 L33.0087747,0 C14.7765263,0 0,14.7785318 0,33.0087747 L0,222.991225 Z" fill="#563D7C"></path>
      ...
      <div class="skill-pair reverse">
        <div class="skill-image">
          <svg viewBox="0 -198 512 512" xmlns="http://www.w3.org/2000/svg">
            <title>jQuery</title>
            <g fill="none" fill-rule="evenodd">
              <path style="fill:white" d="M489.718 8.646l21.42.118s-39.824 53.964-43.076 58.362c-1.056 1.424-2.66 2.96-3.474 4.864-2.057 4.786-4.169 15.285-4.169 15.285l-19.599.098s3.05-10.944 2.924-16.773c-.11-5.092-2.71-10.178-4.168-15.285-1.474-5.17-3.475-15.286-3.475-15.286h20.15l2.779 11.117 30.688-42.5" fill="#1A1918"/>
      ...
      <div class="skill-pair reverse">
        <div class="skill-image">
          <svg viewBox="0 -183.5 512 512" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet">
            <title>nodeJS</title>
            <g class="svg-color" fill="#83CD29">
      ...
      <div class="skill-pair reverse">
        <div class="skill-image">
          <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <title>VueJS</title>
            <path class="svg-color" d="m12 12.765 5.592-9.437h-3.276L12 7.33v.002L9.688 3.328h-3.28z" fill="#83CD29" />
            <path class="svg-color" d="M18.461 3.332 12 14.235 5.539 3.332H1.992L12 20.672l10.008-17.34z" fill="#00bd7e" />
          </svg>
        </div>
        <div class="skill-text">
          Lorem ipsum dolor, sit amet consectetur adipisicing elit. Odio perferendis quam ipsa porro, soluta deserunt adipisci quidem rerum harum, dolores temporibus ad, earum tempore mollitia accusamus commodi corrupti reprehenderit? Incidunt!
  ...
  <section class="tool-section">
    ...
    <div class="tool-group">
      <div class="skill-pair tool-pair">
        <div class="skill-image">
          <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            <title>VSCcode</title>
            <path class="svg-color" d="M27.5,5.5H18.2L16.1,9.7H4.4V26.5H29.6V5.5Zm0,4.2H19.3l1.1-2.1h7.1Z" fill="#5594bf"/>
            <path class="svg-color" d="M30.257,12.333l-4.324-2.082a1.308,1.308,0,0,0-1.492.253L10.285,23.411a.875.875,0,0,0-.057,1.236.766.766,0,0,0,.057.057l1.157,1.052a.873.873,0,0,0,1.116.049L29.607,12.873A.868.868,0,0,1,31,13.565v-.05A1.311,1.311,0,0,0,30.257,12.333Z" fill="#0065a9"/>
            <path class="svg-color" d="M30.257,28.788,25.933,30.87a1.308,1.308,0,0,1-1.492-.253L10.285,17.71a.875.875,0,0,1-.057-1.236.766.766,0,0,1,.057-.057l1.157-1.052a.873.873,0,0,1,1.116-.049L29.607,28.248A.868.868,0,0,0,31,27.556v.05A1.311,1.311,0,0,1,30.257,28.788Z" fill="#007acc"/>
            <path class="svg-color" d="M25.933,30.871a1.308,1.308,0,0,1-1.491-.254.768.768,0,0,0,1.311-.543V11.047a.768.768,0,0,0-1.311-.543,1.306,1.306,0,0,1,1.491-.254l4.324,2.079A1.314,1.314,0,0,1,31,13.512v14.1a1.314,1.314,0,0,1-.743,1.183Z" fill="#1f9cf0"/>
          </svg>
        </div>
        <div class="skill-text tool-text">
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Asperiores aliquam ea ratione numquam omnis nihil et error quasi sapiente, enim corporis doloremque velit minima quaerat ab hic animi mollitia impedit.          
        </div>
      </div>
      <div class="skill-pair tool-pair">
        <div class="skill-image">
          <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            ...
            <title>GitHub</title>
            <path class="svg-color" id="SVGCleanerId_0" fill="#3E77BF" d="M247.992,5.163C111.048,5.163,0,116.627,0,254.163
            ...
            <g>
              <path class="svg-color" id="SVGCleanerId_0_1_" fill="#3E77BF" d="M247.992,5.163C111.048,5.163,0,116.627,0,254.163
                c0,109.992,71.048,203.32,169.632,236.24c12.392,2.296,16.912-5.392,16.912-12c0-5.904-0.216-21.56-0.336-42.344
                c-69,15.064-83.552-33.376-83.552-33.376c-11.264-28.768-27.52-36.408-27.52-36.408c-22.528-15.456,1.696-15.16,1.696-15.16
                c24.88,1.752,37.976,25.672,37.976,25.672c22.144,38.048,58.064,27.048,72.192,20.672c2.232-16.08,8.656-27.064,15.736-33.28
                c-55.056-6.296-112.944-27.64-112.944-123.04c0-27.176,9.656-49.408,25.52-66.832c-2.568-6.296-11.072-31.6,2.416-65.872
            ...
            <g>
              <path class="svg-color" fill="#114C82" d="M378.496,109.131c13.128,33.904,4.752,58.928,2.2,65.176c15.904,17.424,25.504,39.648,25.504,66.832
                c0,95.64-57.984,116.68-113.232,122.856c8.904,7.688,16.832,22.872,16.832,46.112c0,33.296-0.296,60.128-0.296,68.296
              ...
              <path class="svg-color" fill="#114C8;" d="M192.976,377.323c2.784-5.616,6.184-9.984,9.76-13.144c-30.176-3.456-61.168-11.512-83.048-33.744
                C136.52,358.451,163.928,371.195,192.976,377.323z"/>
            </g>
            <path class="svg-color" fill="#6CA9EA" d="M12.912,270.947c0-137.536,111.048-249,247.992-249c76.04,0,144.056,34.392,189.536,88.488
            ...
            <path class="svg-color" fill="#083E66" d="M322.712,426.899c0-23.232-7.928-38.44-16.832-46.128c55.248-6.16,113.24-27.216,113.24-122.848
            ...
            <path class="svg-color" fill="#114C82" d="M117.464,423.995c5.208,10.72,22.712,36.4,68.888,30.992c-0.064-5.648-0.112-11.976-0.144-18.928
              C150.584,443.835,129.552,434.667,117.464,423.995z"/>
            <path class="svg-color" fill="#6CA9EA" d="M126.368,391.387c-1.592-2.4-4.576-6.472-8.904-10.544
        ...
        <div class="skill-image">
          <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <g fill="none" fill-rule="evenodd" transform="translate(4)">
              <circle class="svg-color" cx="12" cy="12" r="4" fill="#19BCFE"/>
              <path class="svg-color" fill="#09CF83" d="M4,24 C6.209139,24 8,22.209139 8,20 C8,19.3969461 8,18.0636128 8,16 C6.20303877,16 4.86970543,16 4,16 C1.790861,16 0,17.790861 0,20 C0,22.209139 1.790861,24 4,24 Z"/>
              <path class="svg-color" fill="#A259FF" d="M4,16 C4.73637967,16 6.069713,16 8,16 L8,8 C6.069713,8 4.73637967,8 4,8 C1.790861,8 0,9.790861 0,12 C0,14.209139 1.790861,16 4,16 Z"/>
              <path class="svg-color" fill="#F24E1E" d="M4,8 C4.73637967,8 6.069713,8 8,8 L8,0 C6.069713,0 4.73637967,0 4,0 C1.790861,0 0,1.790861 0,4 C0,6.209139 1.790861,8 4,8 Z"/>
              <path class="svg-color" fill="#FF7262" d="M12,8 L8,8 L8,8 L8,0 L12,0 L12,0 C14.209139,0 16,1.790861 16,4 C16,6.209139 14.209139,8 12,8 Z"/>
            </g>
          </svg>
        </div>
        <div class="skill-text tool-text">
...
.skill-pair:not(:hover) .skill-text{
  opacity: 0;
}
